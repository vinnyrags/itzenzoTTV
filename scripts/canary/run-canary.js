...
const CHECKS = [
    ...
    },
    {
        ...
        // 5-second revalidate window on the route caches the GraphQL
        // result, so steady-state hits are <300ms. First call after a
        // deploy can be slower while the cache warms — 1500ms gives
