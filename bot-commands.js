...
const messages = [
    ...
    // Message: Minecraft Realms
    {
        ...
        description: [
            ...
            '> 🎨 — **Bedrock Creative**',
            '',
            '**Bedrock realms (👻 + 🎨)** — react and the bot DMs you the realm invite URL. Your reaction is removed so you can re-react later if you lose the DM.',
            '',
            '**Java Hardcore (🪓)** — react and the bot DMs you a button to submit your Minecraft Java username. On submit, Nous posts a whitelist request to `#ops` (pinging Akivili). Vincent adds you to the realm whitelist manually and reaches out to confirm.',
            '',
